...
| Project | Description |
|--------|-------------|
| [👥 Social Care Business Model](https://github.com/yourusername/igor-makarov-portfolio/tree/main/social-care-model) | End-to-end business development dashboard based on a real social services scenario. In progress — being expanded into a more complex, strategic tool. |
| [🏢 AdventureWorks Sales Analysis](https://github.com/yourusername/igor-makarov-portfolio/tree/main/adventureworks-model) | Sales performance insights, KPIs, and revenue breakdowns using Microsoft’s public dataset. |
| [🍬 Candy Sales Tracker](https://github.com/yourusername/igor-makarov-portfolio/tree/main/candy-sales-model) | Regional product performance with forecasting, market segmentation, and slicer-driven filtering. |
| [✈️ Airport Delays Analysis](https://github.com/yourusername/igor-makarov-portfolio/tree/main/airport-delays-model) | Delay cause analysis with seasonal patterns and predictive models. |
